 /******************************************************************************
 * modified.h
 * copy from KaMIS/lib/mis/kernel
 *****************************************************************************/
...
class mis_branch_and_reduce_algorithm;
...
public:
    ...
    mis_branch_and_reduce_algorithm *pAlg;

public:
    modified(int const add, std::vector<int> &removed, std::vector<int> &vs, std::vector<std::vector<int>> &newAdj, mis_branch_and_reduce_algorithm *_pAlg);

    modified(std::vector<int> &removed, std::vector<int> &vs, mis_branch_and_reduce_algorithm *_pAlg);
...
public:
    fold(int const add, std::vector<int> &removed, std::vector<int> &vs, std::vector<std::vector<int>> &newAdj, mis_branch_and_reduce_algorithm *_pAlg)
    : modified(add, removed, vs, newAdj, _pAlg)
    { }

    fold(std::vector<int> &removed, std::vector<int> &vs, mis_branch_and_reduce_algorithm *_pAlg)
...
public:
    ...
    alternative(int const add, std::vector<int> &removed, std::vector<int> &vs, std::vector<std::vector<int>> &newAdj, mis_branch_and_reduce_algorithm *_pAlg, int k)
    : modified(add, removed, vs, newAdj, _pAlg)
    {
        this->k = k;
    }

    alternative(std::vector<int> &removed, std::vector<int> &vs, mis_branch_and_reduce_algorithm *_pAlg, int k)
    : modified(removed, vs, _pAlg)
    {
        this->k = k;
    }
