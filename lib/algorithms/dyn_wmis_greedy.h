#ifndef DYNMISGREEDY_H 
#define DYNMISGREEDY_H
...
class dyn_wmis_greedy : public dyn_wmis_algorithm {
        public:
                dyn_wmis_greedy(const std::shared_ptr<dyn_graph_access>& dyn_graph, const DynWMISConfig & config);
