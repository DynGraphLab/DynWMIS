#ifndef DYNMISGREEDYDEG_H 
#define DYNMISGREEDYDEG_H
...
class dyn_wmis_greedy_deg : public dyn_wmis_algorithm {
        public:
                dyn_wmis_greedy_deg(const std::shared_ptr<dyn_graph_access>& dyn_graph, const DynWMISConfig & config);
