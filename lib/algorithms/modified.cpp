...
modified::modified(int const _add, std::vector<int> &_removed, std::vector<int> &_vs, std::vector<std::vector<int>> &newAdj, mis_branch_and_reduce_algorithm *_pAlg)
: add(_add)
, pAlg(_pAlg) 
{
...
modified::modified(std::vector<int> &_removed, std::vector<int> &_vs, mis_branch_and_reduce_algorithm *_pAlg)
: add(0)
, pAlg(_pAlg)
{
    removed.swap(_removed);
