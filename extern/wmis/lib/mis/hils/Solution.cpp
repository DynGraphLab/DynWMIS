...
extern std::mt19937 generator; // Mersenne Twister 19937 generator
...
void Solution::addRandomVertex()
{
    ...
    std::uniform_int_distribution<int> distribution(0, free_size_ - 1);
...
void Solution::force(int k)
{
	for(int i = 0; i < k; i++) {
        ...
        std::uniform_int_distribution<int> discrete_distribution(0, nonsolution_size - 1);
