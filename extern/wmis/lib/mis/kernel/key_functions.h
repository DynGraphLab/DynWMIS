...
struct ApproximateIncreaseKey {
    ApproximateIncreaseKey(const MISConfig &config) : key_reinsert_factor(config.key_reinsert_factor) {}
...
struct IncreaseKey {
    IncreaseKey(const MISConfig &config) {}
    Gain key(branch_and_reduce_algorithm* br_alg, NodeID n);
    Gain key_by_set_estimate(branch_and_reduce_algorithm* br_alg, NodeID n, size_t set_estimate);
    size_t set_limit(branch_and_reduce_algorithm* br_alg, NodeID n, Gain key);
    size_t set_estimate(branch_and_reduce_algorithm* br_alg, NodeID n, Gain key);
...
struct DegreeKey {
    DegreeKey(const MISConfig &config) {}
    Gain key(branch_and_reduce_algorithm* br_alg, NodeID n);
    Gain key_by_set_estimate(branch_and_reduce_algorithm* br_alg, NodeID n, size_t set_estimate);
    size_t set_limit(branch_and_reduce_algorithm* br_alg, NodeID n, Gain key);
    size_t set_estimate(branch_and_reduce_algorithm* br_alg, NodeID n, Gain key);
...
struct RandomKey {
    RandomKey(const MISConfig &config) : generator(config.seed), distribution(std::numeric_limits<Gain>::min() + 1, std::numeric_limits<Gain>::max() - 1) {}
    Gain key(branch_and_reduce_algorithm* br_alg, NodeID n);
    Gain key_by_set_estimate(branch_and_reduce_algorithm* br_alg, NodeID n, size_t set_estimate);
    size_t set_limit(branch_and_reduce_algorithm* br_alg, NodeID n, Gain key);
    size_t set_estimate(branch_and_reduce_algorithm* br_alg, NodeID n, Gain key);
