        ...
        public:
                ...
                void sort_local_adj() {
                        forall_nodes((*this), node) {
                                if(get_first_edge(node) != get_first_invalid_edge(node)) 
                                        std::sort(graphref->m_edges.begin() + get_first_edge(node), graphref->m_edges.begin()+get_first_invalid_edge(node), compareEdges);
                        } endfor
                }
